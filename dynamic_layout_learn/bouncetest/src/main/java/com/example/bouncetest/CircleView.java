...
public class CircleView extends View {
    ...
    public CircleView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        final float arcWidth = DimenUtils.dp2px(15f);
        mBallRadius = DimenUtils.dp2px(8f);
        mOver = DimenUtils.dp2px(6f);
    ...
    private void drawDot(Canvas canvas) {
        ...
        final Shader shader = new RadialGradient(mCurrentPositions[0], mCurrentPositions[1], mBallRadius + mOver, 0xff3c2b1, 0x00ff0000, Shader.TileMode.CLAMP);
